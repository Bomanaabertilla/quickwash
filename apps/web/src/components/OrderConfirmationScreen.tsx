...
export default function OrderConfirmationScreen({
  ...
  const displayRef = bookingReference || 'LB-NEW-ORDER';

  const handleCopy = () => {
    navigator.clipboard?.writeText(displayRef.replace(/\s+/g, ''));
    setCopied(true);
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[#f7f9fc]">
      ...
      <div className="px-5 py-2.5 flex items-center justify-between text-xs bg-[#f7f9fc]">
        ...
        <Badge variant="success" className="font-extrabold px-2.5 py-0.5 rounded-full text-[11.5px] flex items-center gap-1">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar px-5 pt-1 pb-24 flex flex-col gap-4">
        ...
        <Card className="rounded-2xl p-4 border-slate-200/80 shadow-xs flex flex-col items-center justify-center text-center gap-1 bg-white">
          ...
          <div className="flex items-center gap-2.5 my-1">
            ...
            <button
              onClick={handleCopy}
              className="p-1 rounded-md hover:bg-slate-100 text-[#006a60] transition-colors cursor-pointer"
        ...
        <Card className="rounded-2xl p-4 border-slate-200/80 shadow-xs flex flex-col gap-3 bg-white">
          <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col gap-2.5 mt-1">
          <Button
            onClick={onTrackStatus || (() => alert('Tracking pickup status...'))}
            className="w-full h-12 bg-[#006a60] hover:bg-[#005850] text-white rounded-2xl font-bold text-sm flex items-center justify-center gap-2 shadow-md active:scale-[0.99] transition-all cursor-pointer"
          >
          ...
          <Button
            ...
            className="w-full h-12 bg-white hover:bg-slate-50 text-slate-800 border-slate-200/90 rounded-2xl font-bold text-sm flex items-center justify-center gap-2 shadow-xs active:scale-[0.99] transition-all cursor-pointer"
          >
