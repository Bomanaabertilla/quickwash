...
export default function PaymentCheckoutScreen({
  ...
  const handleNetworkSwitch = (netId) => {
    setActiveNetwork(netId);
    setCountdown(45);
    if (netId === 'mtn') setPhone('+233 24 123 4567');
    else if (netId === 'telecel') setPhone('+233 20 888 9900');
    else if (netId === 'at') setPhone('+233 27 555 4433');
  };
  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[#f7f9fc]">
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar px-5 pt-3 pb-24 flex flex-col gap-3">
        ...
        <header className="flex items-center justify-between pt-1">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="w-9 h-9 rounded-full bg-[#006a60] text-white flex items-center justify-center shadow-sm shadow-[#006a60]/20 hover:bg-[#005850] transition-colors"
        ...
        <div className="bg-white rounded-2xl p-4 border border-slate-200/80 shadow-xs flex flex-col gap-2">
          ...
          <div className="flex items-center justify-between text-xs text-slate-600">
            ...
            <span className="font-bold text-[#006a60] flex items-center gap-1">
              {currentNetConfig.shortName} ({phone})
            </span>
          </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200/90 shadow-sm flex flex-col flex-1 min-h-[310px] overflow-hidden justify-between">
          ...
          <div className="bg-[#f0f4f9] p-3.5 px-4 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className={`w-6 h-6 rounded-lg font-black text-[10px] flex items-center justify-center shadow-xs ${currentNetConfig.badgeClass}`}>
          ...
          <div className="p-4 flex-1 flex flex-col justify-between gap-4">
            ...
            {/* Amber Alert Callout Box (Exact match to prompt screenshot!) */}
            <div className="bg-[#fff9e6] border border-[#fce9a6] rounded-2xl p-3.5 flex items-center justify-between gap-3 shadow-xs">
              ...
              <div className="w-8 h-8 rounded-lg bg-amber-100/80 flex items-center justify-center text-amber-800 flex-shrink-0">
                <svg className="w-5 h-5 stroke-[2]" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  ...
                  <line x1="12" y1="18" x2="12.01" y2="18" strokeWidth="2.5" strokeLinecap="round"></line>
                  <path d="M19 8a3 3 0 0 1 0 8" strokeWidth="1.5" strokeLinecap="round"></path>
                </svg>
              </div>
            </div>
      ...
      <div className="bg-[#f7f9fc] border-t border-slate-200/60 px-5 pt-3 pb-5 z-20 flex flex-col gap-3">
        ...
        <button
          ...
          className="w-full h-13 py-3.5 bg-[#006a60] hover:bg-[#005850] text-white rounded-2xl font-bold text-[16px] flex items-center justify-center gap-2.5 shadow-md active:scale-[0.99] transition-all disabled:opacity-80"
        >
          {isAuthorizing ? (
            <div className="flex items-center gap-2">
        ...
        <div className="flex items-center justify-between px-1 text-xs select-none">
          ...
          <button
            onClick={onAuthorize}
            className="flex items-center gap-1.5 text-[#006a60] font-bold hover:underline transition-all"
          >
          ...
          <div className="text-slate-600 font-medium">
            {countdown > 0 ? (
              ...
              <button
                ...
                className="text-[#006a60] font-bold hover:underline flex items-center gap-1"
              >
