...
export default function PartnerCard({ partner, isSelected, onSelect }) {
  return (
    <div
      ...
      className={`relative bg-white rounded-2xl p-4 flex gap-4 border transition-all duration-200 cursor-pointer overflow-hidden group shadow-sm hover:shadow-md ${
        isSelected
    ...
    >
      ...
      <div 
        className={`absolute left-0 top-0 bottom-0 w-1.5 bg-brand-teal transition-opacity duration-200 ${
