  ...
  return (
    <div className="flex-1 flex flex-col h-full bg-[#f7f9fc] justify-between p-5 relative overflow-y-auto custom-scrollbar">
      ...
      <div className="w-full flex items-center justify-between pt-2 z-10">
        <button
          onClick={onBackToApp}
          className="bg-white border border-slate-200/80 px-3.5 py-1.5 rounded-full text-xs font-bold text-slate-700 hover:bg-slate-50 transition-all flex items-center gap-1.5 shadow-2xs"
        >
      ...
      {/* Main Container matching user's design image */}
      <div className="flex-1 flex flex-col items-center justify-center my-6 max-w-sm mx-auto w-full">
        ...
        {/* Login Form Card */}
        <div className="bg-white rounded-3xl p-5 border border-slate-200/80 shadow-md w-full mt-6 flex flex-col gap-4">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-3.5">
            ...
            <div className="flex flex-col gap-1.5">
              <div className="flex items-center justify-between text-xs">
                ...
                <button 
                  ...
                  className="text-[11px] font-semibold text-[#006a60] hover:underline"
                >
                  Forgot PIN?
                </button>
              </div>
            ...
            <button
              ...
              className="w-full h-12 bg-[#006a60] hover:bg-[#005850] text-white rounded-2xl font-bold text-sm flex items-center justify-center gap-2 shadow-md active:scale-[0.99] transition-all mt-2 disabled:opacity-80"
            >
              {isSubmitting ? (
          ...
          <button
            type="button"
            onClick={handleLogin}
            className="w-full py-2.5 bg-teal-50 hover:bg-teal-100 text-[#006a60] rounded-2xl font-bold text-xs flex items-center justify-center gap-2 transition-colors border border-teal-100/80"
          >
