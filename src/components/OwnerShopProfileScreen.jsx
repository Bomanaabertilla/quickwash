...
export default function OwnerShopProfileScreen({
  ...
  const [activeTab, setActiveTab] = useState('all'); // 'all' | 'identity' | 'location' | 'hours' | 'contact' | 'facilities'
  ...
  return (
    <div className="flex-1 flex flex-col bg-[#FAF9F5] text-slate-800 pb-28 overflow-y-auto">
        ...
        <div className="max-w-5xl mx-auto px-6 py-4 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="bg-white hover:bg-slate-50 text-slate-700 border border-stone-200 px-3.5 py-2 rounded-xl text-xs font-bold flex items-center gap-2 transition-all shadow-2xs hover:border-slate-300 cursor-pointer"
            ...
            <button
              onClick={handleSave}
              disabled={isSaving}
              className={`px-4 py-2 rounded-xl text-xs font-extrabold flex items-center gap-2 transition-all shadow-xs cursor-pointer ${
                isUnsaved
      ...
      {/* Main Content Area - Centered, Readable, Clean Form */}
      <div className="max-w-5xl mx-auto w-full px-6 py-6 space-y-6">
        ...
        {(activeTab === 'all' || activeTab === 'identity') && (
          <div className="bg-white rounded-2xl p-6 sm:p-7 border border-stone-200/80 shadow-2xs">
            ...
            <div className="mt-5 p-4 rounded-xl bg-stone-50 border border-stone-200/70 flex flex-wrap items-center justify-between gap-4">
              ...
              <button
                ...
                className="text-xs font-bold text-[#006a60] bg-white hover:bg-stone-100 border border-stone-200 px-3 py-1.5 rounded-lg transition-colors cursor-pointer"
              >
                Change Cover Photo
              </button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-stone-50/60 border border-stone-200 rounded-xl px-3.5 py-2.5 text-xs text-slate-900 font-bold focus:outline-none focus:border-[#006a60] focus:bg-white transition-all pr-9"
                  />
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full bg-stone-50/60 border border-stone-200 rounded-xl px-3.5 py-2.5 text-xs text-slate-900 font-bold focus:outline-none focus:border-[#006a60] focus:bg-white transition-all"
                />
              </div>
          ...
          <div className="bg-white rounded-2xl p-6 sm:p-7 border border-stone-200/80 shadow-2xs">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 mt-5">
              ...
              <div className="sm:col-span-2 flex flex-col gap-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-stone-50/60 border border-stone-200 rounded-xl px-3.5 py-2.5 text-xs text-slate-900 font-bold focus:outline-none focus:border-[#006a60] focus:bg-white transition-all pl-9"
                  />
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full bg-stone-50/60 border border-stone-200 rounded-xl px-3.5 py-2.5 text-xs text-slate-900 font-bold focus:outline-none focus:border-[#006a60] focus:bg-white transition-all font-mono"
                />
              </div>
            </div>
            ...
            <div className="mt-5 p-5 rounded-xl bg-stone-50/80 border border-stone-200/80 flex flex-col gap-3">
              ...
              <input
                ...
                className="w-full accent-[#006a60] cursor-pointer h-2 bg-stone-200 rounded-lg"
              />
      ...
      {/* Floating Save Changes Bar (Appears when isUnsaved is true) */}
      {isUnsaved && (
            ...
            <div className="overflow-y-auto p-4 flex flex-col gap-3.5">
              ...
              <div className="grid grid-cols-2 gap-2 pt-2 border-t border-stone-100">
                <button
                  ...
                  className="bg-stone-100 hover:bg-stone-200 text-slate-800 py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition-colors"
                >
                ...
                <button
                  ...
                  className="bg-emerald-600 hover:bg-emerald-700 text-white py-2 rounded-xl text-xs font-bold flex items-center justify-center gap-1.5 transition-colors shadow-2xs"
                >
